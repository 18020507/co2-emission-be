...
async def get_summary_report(company_id: int):
    try:
        logging.info("===> get_summary_report repository <===")
        ...
        response.append(
            {'scope': 'Scope 1', 'activity_type': 'Stationary Combustion', 'co2': fuel_amount})
        fuel_amount = 0
        ...
        response.append(
            {'scope': 'Scope 1', 'activity_type': 'Mobile Combustion', 'co2': fuel_amount})
        response.append(
            {'scope': 'Scope 1', 'activity_type': 'Refrigerants', 'co2': 0})
        response.append(
            {'scope': 'Scope 2', 'activity_type': 'Purchased Electricity', 'co2': 0})
